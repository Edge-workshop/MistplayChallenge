...
class Constants {
    ...
    val fakeJsonObjResponse = "[{\n" +
            ...
            " \t\t\t\t\"img\": \"https://mistplay-static.s3.amazonaws.com/images/timeplay/games/big-farm-mobile-harvest/BigFarmMobileHarvest_Port.jpg\"\n" +
            " \t\t\t},\n" +
            "\n" +
            " \t\t\t{\n" +
            ...
            " \t\t\t},\n" +
            " \t\t\t{\n" +
            " \t\t\t\t\"title\": \"House of FunTM: Free Slots & Casino Slots Machines\",\n" +
            ...
            " \t\t\t},\n" +
            " \t\t\t{\n" +
            " \t\t\t\t\"title\": \"Puppy BlastTM - pets puzzle adventure\",\n" +
            ...
            " \t\t\t},\n" +
            " \t\t\t{\n" +
            " \t\t\t\t\"title\": \"Dice With BuddiesTM Free - The Fun Social Dice Game\",\n" +
            ...
            " \t\t\t\t\"img\": \"https://mistplay-static.s3.amazonaws.com/images/timeplay/games/big-farm-mobile-harvest/BigFarmMobileHarvest_Portr.jpg\"\n" +
            " \t\t\t},\n" +
            " \t\t\t{\n" +
